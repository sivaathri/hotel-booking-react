  ...
  return (
    <form className="space-y-4 w-full max-w-xs" onSubmit={handleSubmit}>
      <div className="space-y-3">
        ...
        <div className="relative">
          <div className="absolute inset-y-0 left-0 pl-2 flex items-center pointer-events-none">
            <FaMobile className="h-4 w-4 text-gray-400" />
          </div>
          <input
            type="text"
            name="mobile"
      ...
      <button
        type="button"
        className="flex items-center justify-center gap-2 w-full py-2 px-3 border border-gray-300 rounded-lg text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150 ease-in-out mt-2"
        onClick={() => {
          if (window.AppleID) {
