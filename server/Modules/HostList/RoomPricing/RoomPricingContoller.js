...
const createRoomPricing = async (req, res) => {
  try {
    const { 
      ...
      instant_payment_enabled, free_cancellation_enabled, refundable1, days_before1, refund_percent1, refundable2, 
      days_before2, refund_percent2, refundable3, days_before3, refund_percent3 
    } = req.body;
