...
const createRoomPricing = async (req, res) => {
  try {
    // Destructure all fields except 'id' from req.body
    const { 
      room_id,property_id, floor, room_type, number_of_rooms, room_capacity_adults, room_capacity_children,
    ...
    // The model returns the full inserted record, including auto-generated id
